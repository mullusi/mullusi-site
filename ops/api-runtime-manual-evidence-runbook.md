...
manual_evidence_missing_count=10
next_evidence_key=schema_applied
...
STATUS:
  ...
  Open issues: 10 checklist rows still require real evidence refs
  Next action: collect the schema_applied public-safe ref, then rerun the checklist validator
