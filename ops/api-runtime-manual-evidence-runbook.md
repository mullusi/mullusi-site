...
STATUS:
  ...
  Open issues: all 13 checklist rows still require real evidence refs
  Next action: collect the first public-safe ref for production_image_published, then rerun the checklist validator
