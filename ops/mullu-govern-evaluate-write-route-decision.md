...
privacy, retention, rollback, contract, support, and runtime witness evidence
close.
...
| Rollback witness | route rollback documented and tested | `AwaitingEvidence` | block |
...
7. Rollback procedure that disables only the evaluate write route while preserving public gateway health routes.
