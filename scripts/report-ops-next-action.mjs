...
export function decideOpsNextAction(evidence) {
  ...
  if (apiExposureSolved) {
    return {
      ...
      manualEvidenceBoundary: "product status promotion decision, public evaluate write-route approval, privacy, contract execution, support readiness, and runtime witness evidence",
    };
  }
