...
export function decideOpsNextAction(evidence) {
  ...
  if (apiExposureSolved) {
    return {
      ...
      manualEvidenceBoundary: "product status promotion decision, public evaluate write-route approval, privacy activation approval, retention activation approval, contract execution, and runtime witness evidence",
    };
  }
