...
const requiredPacketTerms = [
  ...
  { id: "review_update_2026_06_30", text: "## 2026-06-30 Public Probe Update" },
  { id: "status_only_probe_command", text: "command=curl status-only probes for https://api.mullusi.com" },
  { id: "latest_health_status", text: "health_probe_status=200" },
  { id: "latest_gateway_witness_status", text: "gateway_witness_probe_status=404" },
  { id: "latest_runtime_conformance_status", text: "runtime_conformance_probe_status=404" },
  { id: "latest_deployment_witness_status", text: "deployment_witness_probe_status=404" },
  { id: "latest_audit_verify_status", text: "audit_verify_probe_status=404" },
  { id: "latest_proof_verify_status", text: "proof_verify_probe_status=404" },
  { id: "latest_govern_evaluate_post_status", text: "govern_evaluate_post_status=404" },
  { id: "latest_probe_blocked_closure", text: "`AwaitingEvidence` result because current public probes do not expose the" },
  ...
  { id: "control_plane_bridge", text: "## 2026-06-27 External Control-Plane Witness Bridge" },
  {
    id: "control_plane_terminal_dns_ref",
    text: "control_plane_terminal_dns_ref=control-plane:pull/2312:terminal-evidence-dns-reconciliation",
  },
  {
    id: "control_plane_handoff_readiness_ref",
    text: "control_plane_handoff_readiness_ref=control-plane:pull/2314:promotion-handoff-readiness-witness",
  },
  { id: "control_plane_general_agent_readiness", text: "control_plane_general_agent_readiness=production-general-agent" },
  { id: "control_plane_promotion_validator", text: "control_plane_promotion_validator=SolvedVerified" },
  { id: "control_plane_governed_runtime_validator", text: "control_plane_governed_runtime_validator=SolvedVerified" },
  { id: "website_product_runtime_closure_blocked", text: "website_product_runtime_closure_allowed=false" },
  { id: "registry_promotion_blocked", text: "registry_promotion_allowed=false" },
