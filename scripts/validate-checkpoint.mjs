...
export function checkpointSteps(options = {}) {
  ...
  const steps = [
    ...
    nodeStep("product scaffold test syntax", ["--check", "scripts/test-scaffold-product.mjs"]),
    nodeStep("architecture boundary syntax", ["--check", "scripts/validate-architecture-boundaries.mjs"]),
    nodeStep("architecture boundary test syntax", ["--check", "scripts/test-validate-architecture-boundaries.mjs"]),
    nodeStep("checkpoint runner syntax", ["--check", "scripts/validate-checkpoint.mjs"]),
    nodeStep("checkpoint runner test syntax", ["--check", "scripts/test-validate-checkpoint.mjs"]),
    nodeStep("ops gate syntax", ["--check", "scripts/check-ops-gates.mjs"]),
    nodeStep("ops gate test syntax", ["--check", "scripts/test-ops-gates.mjs"]),
    nodeStep("API exposure gate syntax", ["--check", "scripts/check-api-exposure-gate.mjs"]),
    nodeStep("API exposure gate test syntax", ["--check", "scripts/test-check-api-exposure-gate.mjs"]),
    nodeStep("API production readiness syntax", ["--check", "scripts/check-api-production-readiness.mjs"]),
    nodeStep("API production readiness test syntax", ["--check", "scripts/test-check-api-production-readiness.mjs"]),
    nodeStep("domain hardening preflight syntax", ["--check", "scripts/check-domain-hardening-preflight.mjs"]),
    nodeStep("domain hardening preflight test syntax", ["--check", "scripts/test-check-domain-hardening-preflight.mjs"]),
    nodeStep("private recovery inventory syntax", ["--check", "scripts/check-private-recovery-inventory.mjs"]),
    nodeStep("private recovery inventory test syntax", ["--check", "scripts/test-private-recovery-inventory.mjs"]),
    nodeStep("doctrine wording test syntax", ["--check", "scripts/test-validate-site-doctrine-wording.mjs"]),
    nodeStep("search indexing surface syntax", ["--check", "scripts/check-search-indexing-surface.mjs"]),
    nodeStep("search indexing surface test syntax", ["--check", "scripts/test-check-search-indexing-surface.mjs"]),
    nodeStep("website origin checker syntax", ["--check", "scripts/check-website-origin.mjs"]),
    nodeStep("website origin checker test syntax", ["--check", "scripts/test-check-website-origin.mjs"]),
    nodeStep("public visibility checker syntax", ["--check", "scripts/check-public-visibility.mjs"]),
    nodeStep("public visibility checker test syntax", ["--check", "scripts/test-check-public-visibility.mjs"]),
    ...
    nodeStep("live deployment integrity test syntax", ["--check", "scripts/test-check-live-deployment-integrity.mjs"]),
    nodeStep("domain security checker syntax", ["--check", "scripts/check-domain-security.mjs"]),
    nodeStep("domain security test syntax", ["--check", "scripts/test-check-domain-security.mjs"]),
    nodeStep("www canonical redirect gate syntax", ["--check", "scripts/check-www-canonical-redirect-gate.mjs"]),
    nodeStep("www canonical redirect gate test syntax", ["--check", "scripts/test-www-canonical-redirect-gate.mjs"]),
    nodeStep("domain hardening promotion test syntax", ["--check", "scripts/test-promote-domain-hardening-preflight.mjs"]),
    nodeStep("recovery witness promotion test syntax", ["--check", "scripts/test-promote-recovery-witness.mjs"]),
