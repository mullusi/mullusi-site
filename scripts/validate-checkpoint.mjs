...
export function checkpointSteps(options = {}) {
  ...
  const steps = [
    ...
    nodeStep("govern live evidence operator request emitter syntax", ["--check", "scripts/emit-govern-live-evidence-operator-request.mjs"]),
    nodeStep("govern live evidence local intake initializer syntax", ["--check", "scripts/init-govern-live-evidence-local-intake.mjs"]),
    ...
    nodeStep("API runtime manual evidence next reporter syntax", ["--check", "scripts/report-api-runtime-manual-evidence-next.mjs"]),
    nodeStep("API runtime manual evidence intake syntax", ["--check", "scripts/validate-api-runtime-manual-evidence-intake.mjs"]),
    nodeStep("API runtime manual evidence checklist syntax", ["--check", "scripts/validate-api-runtime-manual-evidence-checklist.mjs"]),
    ...
    nodeStep("govern live evidence operator request tests", ["scripts/test-emit-govern-live-evidence-operator-request.mjs"]),
    nodeStep("govern live evidence local intake initializer tests", ["scripts/test-init-govern-live-evidence-local-intake.mjs"]),
    ...
    nodeStep("API runtime manual evidence intake", ["scripts/validate-api-runtime-manual-evidence-intake.mjs"]),
    nodeStep("API runtime manual evidence intake tests", ["scripts/test-validate-api-runtime-manual-evidence-intake.mjs"]),
    nodeStep("API runtime manual evidence checklist", ["scripts/validate-api-runtime-manual-evidence-checklist.mjs"]),
    nodeStep("API runtime manual evidence checklist tests", ["scripts/test-validate-api-runtime-manual-evidence-checklist.mjs"]),
