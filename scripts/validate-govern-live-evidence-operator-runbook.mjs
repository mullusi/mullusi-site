...
const requiredRunbookTerms = [
  ...
  { id: "status_report_public_claim_example", text: "ref=public_claim_update_ref status=missing current=missing local_guard=github:pull/348:govern-public-claim-update accepted_shape=github:pull/NNN:govern-public-claim-update accepted_example=github:pull/123:govern-public-claim-update next_action=collect_public_claim_update_ref" },
  {
  ...
  { id: "local_status_not_product_approval", text: "not a product approval, not route publication, and not runtime witness closure" },
  { id: "committed_template_refs", text: "Confirm every committed template ref is still `missing`." },
