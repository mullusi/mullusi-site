...
const requiredSummaryTerms = [
  ...
  { id: "api_exposure_state", text: "api_exposure_state=AwaitingEvidence" },
  { id: "api_dns_publication_allowed", text: "api_dns_publication_allowed=false" },
  { id: "api_production_readiness_state", text: "api_production_readiness_state=AwaitingEvidence" },
  ...
  { id: "api_gateway_public", text: "api_gateway_public=false" },
