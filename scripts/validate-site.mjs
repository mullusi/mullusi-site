...
function validateOperatingGates() {
  const gateExpectations = [
    ...
    },
    {
      ...
      terms: ["Search Indexing Witness", "SolvedVerified", "Public Search Readback", "Search Console Submission", "robots_root_allow=Pass", "live_sitemap_matches_local=Pass", "search_engine_index_state=AwaitingEvidence", "search_console_sitemap_status=Success", "first_party_search_result_observed=false", "STATUS:"],
    },
    {
